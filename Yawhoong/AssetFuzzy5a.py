...
MA = ctrl.Antecedent(np.arange(-400, 401, 1), 'MA')
MA['low'] = fuzz.trapmf(MA.universe, [-400, -400, -60, -40])
...
# Manually set Inputs for testing; alternatively use random generator below
...
# Manually set the df for Fitness function to use
